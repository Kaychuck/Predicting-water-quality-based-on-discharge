...
#get and name water quality file: Total Phosphorus (TP) 
...
xlab(expression(Discharge~(m^3~s^-1)))+ylab(expression(TP~(µmol~L^-1)))+
...
####################################################
# import nitrate-nitrite (NN) and flow file
...
################################## Specific conductivity(SpC or SC)
...
#attach alreasy tss and flow file
...
The R script was adapted from the published script by O’Donnell and Hotchkiss (2019).
